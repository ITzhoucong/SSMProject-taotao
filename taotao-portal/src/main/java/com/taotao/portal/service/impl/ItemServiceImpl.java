...
/**
 * @author: ZhouCong
 * @date: Create in 2019/8/26 12:30
 ...
 */
    ...
    public String getItemDesc(Long itemId) {
        try {
//            查询商品描述
        String josn = HttpClientUtil.doGet(REST_BASE_URL + ITEM_DESC_URL + itemId);
            TaotaoResult result = TaotaoResult.formatToPojo(josn, TbItemDesc.class);
            if (result.getStatus() == 200){
